...
namespace EquipmentSystem.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Username,Passwordhash,Fullname,Roleid")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Username,Passwordhash,Fullname,Roleid")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
